...
```toml
[plugins]
minirogue-plugin = { id = "com.github.minirogue", version = "0.0.7" }
``` 
...
As of version 0.0.7 the following dependencies and versions are used:
...
- [Kotlin Symbol Processing](https://github.com/google/ksp/releases) = 2.1.10-1.0.31
