...
```toml
[plugins]
minirogue-plugin = { id = "com.github.minirogue", version = "0.0.14" }
``` 
...
As of version 0.0.14 the following dependencies and versions are used:
...
- [Metro](https://github.com/ZacSweers/metro/releases) = 0.3.5
