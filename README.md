...
```toml
[plugins]
minirogue-plugin = { id = "com.github.minirogue", version = "0.2.1" }
``` 
...
As of version 0.2.1 the following dependencies and versions are used:
...
- [Metro](https://github.com/ZacSweers/metro/releases) = 0.10.4
