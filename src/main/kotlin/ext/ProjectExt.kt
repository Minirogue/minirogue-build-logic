...
internal fun Project.generateProjectNamespace(): String = "com.${rootProject.name}.${modulePath.joinToString(".").replace("-", ".")}"

internal fun Project.generateResourcePrefix(): String = modulePath.first { it != "feature" && it != "library" }.replace("-", "_") + "_"
